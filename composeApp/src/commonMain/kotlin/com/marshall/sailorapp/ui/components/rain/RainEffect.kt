package com.marshall.sailorapp.ui.components.rain
...
import com.marshall.sailorapp.data.model.RainDrop
                ...
                if (Random.nextFloat() < 0.8f) {
                    rainDrops.add(
                        RainDrop(
                            ...
                            y = Random.nextFloat() * (seaLevelYPx * 0.4f), // Starts from the top 40% of the screen above sea level
